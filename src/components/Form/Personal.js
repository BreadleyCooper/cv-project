...
const Personal = (props) => {
    ...
    const handleChange = (event) => {
        ...
        setDetails(...prevDetails => { return{...prevDetails,[event.target.name]: value}})
    }

    const handleTextareaChange = (event) => {
        setDetails(prevDetails => {
            return{
                ...prevDetails, personalDescription: event.target.value 
            }
        })
    }
        ...
        return (
            <div className="personalForm">
                ...
                <form>
                    ...
                    <input type="text" name="lastName" value={details.lastName} onChange={handleChange}  id="last_name" placeholder="Last Name"></input>

                    <label htmlFor="job_title">Job Title</label>
                    <input type="text" name="jobTitle" value={details.jobTitle} onChange={handleChange}  id="job_title" placeholder="Job Title"></input>

                    <label htmlFor="phone">Phone Number</label>
                    <input type="tel" name="phone" value={details.phone} onChange={handleChange} id="phone" pattern="[0-9]" placeholder="Phone Number"></input>

                    <label htmlFor="email">Email</label>
                    <input type="email" name="email" value={details.email} onChange={handleChange}  id="first_name" placeholder="Email"></input>

                    <label htmlFor="address">Address</label>
                    <input type="text" name="address" value={details.address} onChange={handleChange}  id="address" placeholder="Address"></input>

                    <label htmlFor="description">Personal Description</label>
                    <textarea type="text" name="description" value={details.personalDescription} onChange={handleTextareaChange}  id="description" placeholder="Describe yourself here"></textarea>
                    <button id="eButton" onClick={handleSubmit}>Save</button>
                </form>
            </div>
        )
        }
